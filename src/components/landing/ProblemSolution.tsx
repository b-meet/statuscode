...
export function ProblemSolution() {
    return (
        <section className="py-20 bg-white bg-black border-y border-white/5">
            <div className="container mx-auto px-6">
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <motion.div
                        ...
                        className="bg-zinc-50 bg-zinc-900/50 p-8 rounded-2xl border border-white/5"
                    >
                        ...
                        <ul className="space-y-3">
                            {[
                                ...
                                <li key={i} className="flex items-start gap-3">
                                    ...
                                    <span className="text-zinc-700 text-zinc-300 text-sm font-medium">{item}</span>
                                </li>
                            ))}
                        </ul>
                    </motion.div>
