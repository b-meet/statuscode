            ...
            <div className="container mx-auto px-6">
                <div className="flex flex-col lg:flex-row items-center gap-16">
                    ...
                    <div className="lg:w-1/2 w-full">
                        <div className="relative rounded-2xl bg-zinc-900/50 border border-white/5 p-8 md:p-12">
                            <div className="flex justify-between items-center mb-12">
                                ...
                                <motion.div
                                    ...
                                    className="w-24 h-24 rounded-xl bg-zinc-800 shadow-xl flex flex-col items-center justify-center gap-2 border border-white/5"
                                >
                                ...
                                <div className="flex-1 flex items-center justify-center relative px-4">
                                    <div className="h-0.5 w-full bg-zinc-700 relative overflow-hidden">
                                        <motion.div
                                            animate={{ x: ["-100%", "100%"] }}
                                    ...
                                    <div className="absolute bg-zinc-950 p-2 rounded-full border border-zinc-800">
                            ...
                            <div className="bg-zinc-950 rounded-lg p-4 shadow-sm border border-white/5">
                                <div className="flex items-center gap-3 mb-2">
                                    <div className="h-2 w-2 rounded-full bg-green-500 animate-pulse" />
                                    <span className="text-xs font-mono text-green-600 text-green-400">api.statuscode.in is operational</span>
                                </div>
